(* OASIS_START *)
(* DO NOT EDIT (digest: c88f620e7acae2f6594c1818e94bbdef) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml =
       [
          ("cconv", ["src"], []);
          ("ppx_deriving_cconv", ["ppx"], []);
          ("cconv_sexp", ["sexp"], []);
          ("cconv_yojson", ["yojson"], []);
          ("cconv_bencode", ["bencode"], []);
          ("cconv_psexp", ["psexp"], [])
       ];
     lib_c = [];
     flags =
       [
          ([
              "oasis_library_ppx_deriving_cconv_native";
              "ocaml";
              "link";
              "native"
           ],
