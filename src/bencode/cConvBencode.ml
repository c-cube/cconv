...
let output =
  ...
  { E.unit = Bencode.Integer 0;
    ...
    char = (fun x -> Bencode.String (String.make 1 x));
    nativeint = (fun i -> Bencode.Integer (Nativeint.to_int i));
    int32 = (fun i -> Bencode.Integer (Int32.to_int i));
    int64 = (fun i -> Bencode.Integer (Int64.to_int i));
