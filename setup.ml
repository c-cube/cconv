...
(* OASIS_START *)
(* DO NOT EDIT (digest: d2e7a5d80d8c0a844469c98623ee0515) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("./run_tests_ppx.native", []))];
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/c-cube/cconv";
          bugreports = None;
            ...
            [
               Flag
                 ({
                  ...
                  },
                   {
                      flag_description =
                        Some
                          "Build and install ppx_deriving_cconv, to derive encoders and decoders";
               ...
               Flag
                 ({
                  ...
                  },
                   {
                      flag_description =
                        Some
                          "Build and install the interface to Sexplib (requires Sexplib)";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
                  ...
                  },
                   {
                      flag_description =
                        Some
                          "Build and install the interface to Yojson (requires Yojson)";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
                  ...
                  },
                   {
                      flag_description =
                        Some
                          "Build and install the interface to Bencode (requires Bencode)";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Build benchmarks (require \"benchmark\")";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Library
                 ({
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_dllpath = [(OASISExpr.EBool true, [])];
                      bs_byteopt = [(OASISExpr.EBool true, [])];
                      bs_nativeopt = [(OASISExpr.EBool true, ["-linkall"])]
                   },
                   {
                      lib_modules = ["Ppx_deriving_cconv"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "cconv";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["CConvYojson"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "cconv";
                      lib_findlib_name = Some "yojson";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "cconv_bencode";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["CConvBencode"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "cconv";
                      lib_findlib_name = Some "bencode";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "psexp";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "cconv"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                   ...
                   {
                      lib_modules = ["CConvPSexp"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "cconv";
                      lib_findlib_name = Some "psexp";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "all.ml"});
               Executable
                 ({
                     cs_name = "run_bench";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "run_bench.ml"});
               Executable
                 ({
                     cs_name = "run_tests_ppx";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                              ...
                              (OASISExpr.EAnd
                                 (OASISExpr.EAnd
                                    (OASISExpr.EFlag "tests",
                                      OASISExpr.EFlag "ppx"),
                                   OASISExpr.EFlag "yojson"),
                                OASISExpr.EFlag "bencode"),
                             true)
                        ];
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "tests";
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "cconv";
                           InternalLibrary "cconv_yojson";
                           InternalLibrary "ppx_deriving_cconv";
                           InternalLibrary "cconv_bencode";
                           FindlibPackage ("yojson", None);
                           FindlibPackage ("bencode", None);
                   ...
                   {exec_custom = false; exec_main_is = "run_tests_ppx.ml"});
               Test
                 ({
                     cs_name = "all";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ...
                           InternalExecutable "run_tests_ppx"
                        ]
                   });
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "Documentation for CConv";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               SrcRepo
                 ({
                   ...
                   {
                      src_repo_type = Git;
                      src_repo_location = "https://github.com/c-cube/cconv";
                      src_repo_browser =
                        Some
                          "https://github.com/c-cube/cconv/tree/master/src";
     ...
     oasis_digest = Some "\153\233J\157{*H\163\254{\228fK\135\174\141";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
